export const Messages = {
    ...
    Prompts: {
        ...
        EnterFilterGroupName: 'Enter Text Filter Group Name',
        ...
        ExportTextFilters: 'Export Text Filters',
        ExportRegexFilters: 'Export Regex Filters',
        ExportGroup: 'Export Group: {0}',
        ImportTextFilters: 'Import Text Filters',
        ImportRegexFilters: 'Import Regex Filters',
        ConfirmClearAllData: 'Are you sure you want to clear ALL persistent data? This includes all profiles, filters, bookmarks, workflows, and runbooks. This action cannot be undone.',
        ConfirmClearTextFilterData: 'Are you sure you want to clear all text filter groups?',
        ConfirmClearRegexFilterData: 'Are you sure you want to clear all regex filter groups? The default Presets group will be restored.',
        ConfirmClearBookmarkData: 'Are you sure you want to clear all bookmark data?',
        ConfirmClearWorkflowData: 'Are you sure you want to clear all workflow data?',
        ConfirmClearRunbookData: 'Are you sure you want to clear all runbook data? This will delete all runbook files.',
    ...
    Messages: {
        Info: {
            ...
            ClearTextFilterDataCompleted: 'Text filter data cleared.',
            ClearRegexFilterDataCompleted: 'Regex filter data cleared. Default Presets group restored.',
            ClearBookmarkDataCompleted: 'Bookmark data cleared.',
            ClearWorkflowDataCompleted: 'Workflow data cleared.',
            ClearRunbookDataCompleted: 'Runbook data cleared.',
            ...
            SelectFilterFirst: 'Please select a filter in the Text Filters view first.',
        ...
        Error: {
            ...
            TextFilterGroupExists: 'Text Filter Group \'{0}\' already exists.',
